...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'pc@ninhh.net',
  ...
  footer:
    'Powered by <a href="/" target="_blank" rel="noopener noreferrer">DESIGNER WWCT</a>. Made with ❤ by Ninh.',
  ...
  email: 'mailto:ninh22199@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/chems2gio1',
    },
  ],
